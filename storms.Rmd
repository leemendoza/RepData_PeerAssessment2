...
## evalWithMemoization is used to read the cached results of reading the storm data. Otherwise, this
## could take awhile
dt =  evalWithMemoization(read.table("FStormData.bz2", header = TRUE, fill = TRUE, stringsAsFactors = FALSE, sep = ","))
