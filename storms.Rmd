...
**Figure 3. Events with the greatest economic consequences in each state. The top panel indicates the weather event leading to the greatest property damage in each state, while the bottom panel indicates the weather event leading to the greatest crop damage.**  
```{r echo = FALSE, fig.width=12, fig.height=12, fig.align='center'}
